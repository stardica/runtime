...
#include <runtime/opencl/x86-program.h>
...
static struct opencl_x86_device_core_t *opencl_x86_device_get_work_group_data(void)
{
...
static int opencl_x86_device_get_next_work_group(struct opencl_x86_device_exec_t *exec)
{
...
void opencl_x86_work_item_entry_point(){
...
void opencl_x86_device_core_init(struct opencl_x86_device_core_t *work_group)
{
	...
	for (i = 0; i < X86_MAX_WORK_GROUP_SIZE; i++)
	{
