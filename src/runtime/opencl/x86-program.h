...
struct opencl_x86_program_t *opencl_x86_program_create(struct opencl_program_t *parent,struct opencl_x86_device_t *device, void *binary, unsigned int length);
...
int opencl_x86_program_valid_binary(void *device, void *binary, unsigned int length);
