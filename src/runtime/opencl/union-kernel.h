...
#include <runtime/opencl/partition-strategy.h>
...
void opencl_union_ndrange_run_partial(struct opencl_union_ndrange_t *ndrange, unsigned int *work_group_start, unsigned int *work_group_count);
